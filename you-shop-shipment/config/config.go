...
import (
	...
	"github.com/TechwizsonORG/shipment-service/config/model"
...
func Init() (
	...
	ghnConfig = &model.GhnConfig{
		BaseUrl: envMap["GHN_BASE_URL"],
		Token:   envMap["GHN_TOKEN"],
		ShopId:  envMap["GHN_SHOP_ID"],
	}

	return databaseConfig, serverConfig, logConfig, rabbitMqConfig, rpcServerEndpoint, ghnConfig, mode
}
